...
const CryptoDetail = ({
  route,
  navigation,
}: RootStackScreenProps<'CryptoDetail'>) => {
  ...
  function optionOnClickHandler(option: { id: number; label: string }) {
        ...
        <View
          ...
          <View>
            ...
            <Text
              style={{
                color:
                  selectedCurrency?.type === 'I' ? COLORS.red : COLORS.green,
                ...FONTS.body3,
              }}>
    ...
    return (
      <View
        ...
        <TextButton
          label="Buy"
          onPress={() =>
            navigation.navigate('CryptoTransaction', {
