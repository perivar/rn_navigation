...
import {
  ...
  icons,
  SIZES,
} from '../../constants/bookstore';
import {
  Book,
  Category,
  MyBook,
  Profile,
} from '../../constants/bookstore/dummy';
...
const Home = ({ navigation }: CustomDrawerScreenProps<'HomeTab'>) => {
  const [myProfile, setMyProfile] = React.useState(dummyData.profileData);
  const [loadedBooks, setLoadedBooks] = React.useState(dummyData.myBooksData);
  ...
  function renderMyBookSection(myBooks: MyBook[]) {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.black }}>
      ...
      <ScrollView style={{ marginTop: SIZES.radius }}>
        {/* Books Section */}
        <View>{renderMyBookSection(loadedBooks)}</View>
